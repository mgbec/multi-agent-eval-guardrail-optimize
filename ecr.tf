...
# ============================================================================
# Fact Checker Agent ECR
# ============================================================================

# Fact Checker Agent ECR Repository
resource "aws_ecr_repository" "factchecker" {
  name                 = "${var.stack_name}-${var.ecr_repository_name}-factchecker"
  image_tag_mutability = "MUTABLE"
  ...
  tags = {
    Name   = "${var.stack_name}-factchecker-ecr-repository"
    Module = "ECR"
    Agent  = "FactChecker"
  }
}

# ECR Repository Policy - Fact Checker
resource "aws_ecr_repository_policy" "factchecker" {
  repository = aws_ecr_repository.factchecker.name
...
# ECR Lifecycle Policy - Fact Checker - Keep last 5 images
resource "aws_ecr_lifecycle_policy" "factchecker" {
  repository = aws_ecr_repository.factchecker.name
